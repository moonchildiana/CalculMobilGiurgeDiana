package com.example.calculatorstiintific
...
import com.example.calculatorstiintific.ui.theme.CalculatorStiintificTheme
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        sqRootBtn.setOnClickListener {
            ...
            if (primaryTV.text.toString().isEmpty()) {
                Toast.makeText(this, "Adaugati un numar valid", Toast.LENGTH_SHORT).show()
            } else {
                val str: String = primaryTV.text.toString()
